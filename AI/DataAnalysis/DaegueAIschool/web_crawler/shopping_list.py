...
# 크롤링 도구
driver = webdriver.Chrome("/home/leesera/PycharmProjects/DaeguAI/venv/Web_crawler/driver/chromedriver")
...
df['가격'] = price_list
df['상품링크'] = link_list
df.to_csv("webcrawler_list.csv", index=False, encoding='utf-8')
# print(df)