...
# 구글 이미지 URL
chrome_path = "C:/Users/user/Downloads/daegu_ai/web_crawler/chromedriver.exe"
# window
...
# 해당하는 파일에 이미지 다운로드
os.makedirs("./animal/shark", exist_ok=True)
shark = "./animal/shark/"
if image_name == 'shark' :
...
# 해당하는 파일에 이미지 다운로드
os.makedirs("./animal/dolphin", exist_ok=True)
...
# 해당하는 파일에 이미지 다운로드
os.makedirs("./animal/whale", exist_ok=True)
whale = "./animal/whale/"
if image_name == 'whale' :
    for t, url in enumerate(image_url, 0) :
