...
for image_info in coco_info['images']:
    ...
    file_path = os.path.join("D:\study\DaeguAI\Project\AI\DataAnalysis\DaegueAIschool\web_crawler\src\exam_dataset_220525\data", filename)
    ...
    for bbox, category in zip(annotation["boxes"], annotation["categories"]):
        ...
        cv2.imwrite(r"D:\study\DaeguAI\Project\AI\DataAnalysis\DaegueAIschool\web_crawler\src\exam_dataset_220525\result_1\raccoon_Padding"+ str(idx) + ".png", padding_img)
        print(idx, "번 파일 저장")
        idx += 1
