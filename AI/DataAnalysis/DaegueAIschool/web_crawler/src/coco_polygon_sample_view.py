...
json_path = "D:\study\DaeguAI\Project\AI\DataAnalysis\DaegueAIschool\web_crawler\src\json\instances_polygon.json"
...
for image_info in coco_info["images"]:
    ...
    file_path = os.path.join("D:\study\DaeguAI\Project\AI\DataAnalysis\DaegueAIschool\web_crawler\src\json", filename)
