...
json_path = "/home/leesera/PycharmProjects/DaeguAI/venv/Web_crawler/src/json/instances_default.json"
...
for image_info in coco_info['images']:
    ...
    file_path = os.path.join("/home/leesera/PycharmProjects/DaeguAI/venv/Web_crawler/src/json/", filename)
